...
class UnpaidStudentItem extends StatelessWidget {
  ...
  const UnpaidStudentItem({super.key, required this.name, required this.desc, required this.amount});
        ...
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                Text(name, style: GoogleFonts.roboto(fontWeight: FontWeight.bold, fontSize: 14), overflow: TextOverflow.ellipsis),
