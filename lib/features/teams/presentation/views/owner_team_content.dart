...
class _OwnerTeamContentState extends ConsumerState<OwnerTeamContent> {
            ...
            if (groupToEdit == null) {
              ref
                  ...
                  .createTeam(
                    ...
                    name: name,
                    onSuccess: () =>
                        _showSnackbar("Đã tạo tổ $name", Colors.green),
              ...
              ref
                  ...
                  .updateTeam(
                    ...
                    name: name,
                    onSuccess: () =>
                        _showSnackbar("Đã cập nhật tên tổ", Colors.green),
                    onError: (e) => _showSnackbar(e, Colors.red),
                  );
            }
          },
        ...
        onSelected: (teamId) {
          ref
              ...
              .assignMember(
                ...
                teamId: teamId,
                onSuccess: () =>
                    _showSnackbar("Đã phân tổ thành công", Colors.green),
                onError: (e) => _showSnackbar(e, Colors.red),
              );
        },
      ),
  ...
  Widget build(BuildContext context) {
    ...
    final unassignedAsync = ref.watch(
      unassignedMembersProvider(widget.classId),
    );
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Tổ chức và phân công thành viên",
                      ...
                      children: groups
                          .map(
                            (g) => GroupCard(
                              ...
                              isEditable: true,
                              onEditGroup: (group) =>
                                  _showTeamDialog(groupToEdit: group),
                              onDeleteGroup: (group) =>
                                  _confirmDeleteTeam(group),
                              ...
                              onPromoteMember: (member) {
                                ref
                                    ...
                                    .assignLeader(
                                      ...
                                      memberId: member.id,
                                      onSuccess: () => _showSnackbar(
                                        "Đã chỉ định ${member.name} làm Tổ trưởng",
                                        Colors.green,
                                      ),
                                      onError: (e) =>
                                          _showSnackbar(e, Colors.red),
                  ...
                  unassignedAsync.when(
                    ...
                    data: (members) {
                      ...
                      return Column(
                        children: members
                            .map(
                              (member) => UnassignedMemberItem(
                                member: member,
                                isEditable: true,
                                onAssign: () =>
                                    _showSelectTeamDialog(member.id),
                              ),
                            )
                            .toList(),
                      );
