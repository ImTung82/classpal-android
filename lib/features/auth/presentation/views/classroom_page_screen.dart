...
class ClassroomPageScreen extends StatelessWidget {
    ...
    return GestureDetector(
      onTap: () {
        if (role == 'Lớp trưởng') {
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (_) => const OwnerShellScreen()));
        } else {
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (_) => const StudentShellScreen()));
        }
      },
      child: Container(
  ...
  Widget _createClassButton(BuildContext context) {
    return GestureDetector(
      onTap: () {
